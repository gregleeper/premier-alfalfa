...
import { batchAddPayments } from "../../src/graphql/mutations.ts";
import moment from "moment";
import { API } from "aws-amplify";
const BulkCreatePayments = () => {
  ...
  const findNonStringKeys = (obj) => {
    const nonStringKeys = ["amount", "totalPounds", "tonsCredit"];
    Object.keys(obj).forEach((key) => {
      if (obj[key] === "") {
        delete obj[key];
      }
...
export default BulkCreatePayments;
